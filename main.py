...
Usage:
    ...
    python main.py -q "질문"        # Single question
    python main.py --search-qna "키워드"   # Search QnA
    python main.py --search-tos "키워드"   # Search ToS
    python main.py --verify -q "질문"      # With verification
"""
