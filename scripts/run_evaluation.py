...
def parse_args():
    ...
    parser.add_argument(
        "--auto-diverse-judge",
        action="store_true",
        help="Auto-select a judge model different from the dataset's generator model",
    )
    parser.add_argument(
        "--strict-diversity",
        action="store_true",
...
def main():
    ...
    # Load dataset metadata for generator info (needed for diversity check)
    ...
    if args.use_llm_judge:
        try:
            ...
            if args.auto_diverse_judge and generator_model:
                logger.info(
                    f"Auto-selecting diverse judge (generator was {generator_provider}/{generator_model})"
                )
            else:
            ...
            llm_judge = create_llm_judge(
                ...
                auto_diverse=args.auto_diverse_judge,
